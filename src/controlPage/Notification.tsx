...
function Notification() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] w-full">
      <ControlBody>
        <div className="flex flex-col gap-4 p-6 w-full bg-white rounded-lg shadow-sm">
          ...
          {notificationList.length === 0 ? (
            ...
            notificationList.map((notification, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-xl shadow-lg px-6 py-4 flex justify-between items-center w-full transition hover:shadow-xl hover:border-blue-300 notification-blur"
              >
