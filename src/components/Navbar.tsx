    ...
    {!isControl ? (
      <>
        <li className="w-1/5 text-center">
          <Link to="/homepage" className="flex flex-col items-center text-white hover:text-orange-500">
            <Home size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Home</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/inventory" className="flex flex-col items-center text-white hover:text-orange-500">
            <Package size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Inventory</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/sales" className="flex flex-col items-center text-white hover:text-orange-500">
            <ShoppingCart size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Sales</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/users" className="flex flex-col items-center text-white hover:text-orange-500">
            <Users size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Users</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/control" className="flex flex-col items-center text-white hover:text-orange-500">
            <Settings size={20} />
      ...
      <>
        ...
        <li className="w-1/5 text-center">
          <Link to="/environment" className="flex flex-col items-center text-white hover:text-orange-500">
            <Thermometer size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Environmental Control</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/feedWater" className="flex flex-col items-center text-white hover:text-orange-500">
            <Droplets size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Feeding & Watering</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/poultry" className="flex flex-col items-center text-white hover:text-orange-500">
            <Feather size={20} />
            <span className="text-[11px] leading-tight whitespace-normal">Poultry</span>
          </Link>
        </li>
        <li className="w-1/5 text-center">
          <Link to="/notification" className="flex flex-col items-center text-white hover:text-orange-500">
            <Bell size={20} />
