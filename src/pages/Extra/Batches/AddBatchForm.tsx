            ...
            >
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Please input the batch name!',
                        },
                    ]}
                >
                    <Input />
                ...
                <Form.Item
                    ...
                    label='Cage Number'
                    rules={[
                        { required: true, message: 'Please select a cage!' },
                    ]}
                >
                    <Select placeholder='Select a cage for this batch'>
                        <Option value='Cage 1'>Cage 1</Option>
                        <Option value='Cage 2'>Cage 2</Option>
                        <Option value='Cage 3'>Cage 3</Option>
                    </Select>
                </Form.Item>
                {/* --- END NEW FIELD --- */}
                ...
                <Form.Item
                    name='TotalChickCost'
                    label='Total Chick Cost (Calculated)'
                >
                    <InputNumber
                        style={{ width: '100%' }}
                        disabled
