  ...
  if (!data || data.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Financial Forecast</h3>
          ...
          <div key={item.batchId} className="space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs text-gray-500">
                ...
                <span>Est. Revenue: {formatCurrency(item.estimatedRevenue)}</span>
              </div>
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="text-gray-500">
                  {formatCurrency(item.estimatedRevenue - item.accruedCost)} Projected
                </span>
              </div>
            </div>
          </div>
